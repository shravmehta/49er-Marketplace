...
module.exports.addItem = function(prod_name, prod_code, Email, location, category, price, productdesc){
  var prod = new product_model({prod_name: prod_name, prod_code: prod_code, Email: Email, location: location, category: category, price: price, productdesc: productdesc,main_image: "",image_1: "",image_2: "",image_3: ""});
            console.log(prod);
            prod.save(function(err) {
                    if(err) console.log('Error on save' + err);
                  });
...
module.exports.deleteItem = function (code) {
      ...
      module.exports.getLastProduct = function () {
        try{
          var last_prod = product_model.find().limit().sort({$natural:-1});
          return last_prod;
        }
        catch(err){
